...
const projects: Project[] = [
  {
    ...
    longDescription:
      "A comprehensive e-commerce platform built with React, Node.js, and PostgreSQL. Features include real-time inventory tracking, payment processing with Stripe, advanced search and filtering, admin dashboard, and mobile-responsive design.",
  ...
  },
  {
    ...
    title: "AI Dashboard",
    description:
      "Interactive dashboard for machine learning model visualization",
    longDescription:
      "An advanced analytics dashboard that visualizes machine learning model performance and predictions. Built with React, D3.js, and Python backend. Features real-time data streaming, interactive charts, and model comparison tools.",
    image: "/api/placeholder/600/400",
  ...
  },
  {
    ...
    longDescription:
      "A secure mobile banking application featuring biometric authentication, real-time transaction monitoring, budget tracking, and investment portfolio management. Built with React Native and secure backend infrastructure.",
    image: "/api/placeholder/600/400",
    tags: ["React Native", "Node.js", "MongoDB", "JWT", "Biometrics"],
    category: "mobile",
    liveUrl: "https://example.com",
    featured: true,
  },
  {
    ...
    longDescription:
      "A complete design system with reusable components, design tokens, and documentation. Includes Figma libraries, React component library, and automated design-to-code workflows.",
    image: "/api/placeholder/600/400",
    tags: ["Figma", "Storybook", "React", "TypeScript", "Design Tokens"],
    category: "design",
    githubUrl: "https://github.com",
    featured: false,
  },
